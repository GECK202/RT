...
"	color.x = fmin(color.x, 255);"
"	color.y = fmin(color.y, 255);"
"	color.z = fmin(color.z, 255);"
...
"		r_color.x = fmin(r_color.x, 255);"
"		r_color.y = fmin(r_color.y, 255);"
"		r_color.z = fmin(r_color.z, 255);"
